export default function Loading() {
  return (
    <div className="container relative mx-auto scroll-my-12 overflow-auto p-4 md:p-16 print:p-11">
      <div className="mx-auto w-full max-w-2xl space-y-8 rounded-3xl bg-card p-6 print:space-y-4 print:rounded-none print:bg-white print:p-0">
        {/* Header skeleton */}
        <div className="flex items-center justify-between">
          ...
          <div className="size-28 animate-pulse rounded-xl bg-muted/50" />
        </div>
